...
enum psi_flag_stat {
	...
	PSI_FLAG_STAT_SDT_OTHER		= 0x00010000,
	PSI_FLAG_STAT_NIT_OTHER		= 0x00020000,
	PSI_FLAG_STAT_PMT           = 0x00040000,
};
...
typedef INT32(*si_parser_t)(UINT8 *, INT32, void *);
