...
#define AVS_VIDEO_PID_FLAG 			0x4000
...
#if (defined(_MHEG5_ENABLE_) ||defined(_MHEG5_V20_ENABLE_) || defined(AUTO_OTA))
...
#if (MPEG4_DEFINITION==SYS_FUNC_ON)
     UINT16       mpeg4_flag;   //bit0 : iso/iec 14496-2 video , bit1 : iso/iec-14496-3 audio, bit2 MPEG4 AAC, MPEG4 HE AAC, MPEG4 HE AAC v2
#endif
#endif
#ifdef DTTM_DB
	UINT8 audio_type;
