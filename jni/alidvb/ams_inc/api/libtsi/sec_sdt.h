...
#if ((SYS_CHIP_MODULE == ALI_M3327C) && (SYS_PROJECT_FE == PROJECT_FE_DVBT) && (SYS_SDRAM_SIZE == 2)) ||(SYS_PROJECT_FE == PROJECT_FE_ATSC) \
    ||(defined(FOURM_AT_M3327))
	#define SDT_DEFAULT_NAME				"N\0o\0 \0N\0a\0m\0e\0\0"
	#define SDT_DEFAULT_NAME_LEN			16
#else
