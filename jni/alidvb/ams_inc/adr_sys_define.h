...
#ifndef __ADR_SYS_DEFINE_H_
#define __ADR_SYS_DEFINE_H_
...
#define OS_ALI_TDS2				(SW_TYPE_OS + 1)
#define OS_LINUX				(SW_TYPE_OS + 2)
...
#define CAS_CRYPTON             (SW_TYPE_CA + 10)
#define CAS_BYCA             (SW_TYPE_CA + 11)
/* EPG */
...
#define BOARD_DB_M3701H_01V01		(HW_TYPE_BOARD + 20043)
#define BOARD_DB_M3701C_02V01		(HW_TYPE_BOARD + 20044)
#define BOARD_M3701C_C3069_01		(HW_TYPE_BOARD + 20045)
#define BOARD_DB_M3701C_01V03		(HW_TYPE_BOARD + 20046)
...
#define AV2012					(LLD_DEV_TYPE_TUN + 91)//DVBS2 poe
/* RF modulator */
