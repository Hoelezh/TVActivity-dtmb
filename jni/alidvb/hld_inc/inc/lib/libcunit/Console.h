...
typedef struct CU_TestParams
{
	char *argv[256];
	int   argc;
} CU_TestParams;
typedef CU_TestParams *CU_pTestParams;

CU_EXPORT void CU_customized_list_suites(void);

CU_EXPORT void CU_customized_list_tests(CU_pSuite pSuite);

CU_EXPORT CU_pTestParams CU_get_test_params(void);
