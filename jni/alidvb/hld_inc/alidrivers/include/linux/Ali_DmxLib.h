...
__s32 Ali_DmxSubtStreamOpen(__u32 DmxId);
__s32 Ali_DmxSubtStreamCfg(__s32 StreamId, struct Ali_DmxSubtStreamParam * StreamParam);
__s32 Ali_DmxSubtStreamStart(__s32 StreamId);
__s32 Ali_DmxSubtStreamStop(__s32 StreamId);
__s32 Ali_DmxSubtStreamClose(__s32 StreamId);
